...
/// <summary>
/// DTO utilizado na criação de uma nova transação financeira.
/// Regras de negócio adicionais (compatibilidade categoria/tipo e restrição
/// para menores de idade) são validadas na camada de serviço.
/// </summary>
